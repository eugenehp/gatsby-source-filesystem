...
See docs here - https://www.gatsbyjs.org/packages/gatsby-source-filesystem/
  ...
  let fileNodeQueue = new Map(); // Once bootstrap is finished, we only let one File node update go through
  ...
  emitter.on(`QUERY_QUEUE_DRAINED`, () => {
    currentState = fsMachine.transition(currentState.value, `QUERY_QUEUE_DRAINED`); // If we have any updates queued, run one of them now.
